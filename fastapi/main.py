...
app.include_router(products.router, prefix="/products", tags=["Products with Embeddings"])
...
app.include_router(product_img.router, prefix="/product-images", tags=["Product Images"])
